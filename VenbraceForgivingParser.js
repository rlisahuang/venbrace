...
Expr_blockContext.prototype.and_expr = function() {
...
EmptyExprContext.prototype.LCURLY = function() {
    return this.getToken(VenbraceForgivingParser.LCURLY, 0);
};

EmptyExprContext.prototype.RCURLY = function() {
    return this.getToken(VenbraceForgivingParser.RCURLY, 0);
};

EmptyExprContext.prototype.LSQR = function() {
    return this.getToken(VenbraceForgivingParser.LSQR, 0);
};

EmptyExprContext.prototype.RSQR = function() {
    return this.getToken(VenbraceForgivingParser.RSQR, 0);
};
...
function GetterAbbrevContext(parser, ctx) {
	GetterContext.call(this, parser);
    GetterContext.prototype.copyFrom.call(this, ctx);
    return this;
}

GetterAbbrevContext.prototype = Object.create(GetterContext.prototype);
GetterAbbrevContext.prototype.constructor = GetterAbbrevContext;

VenbraceForgivingParser.GetterAbbrevContext = GetterAbbrevContext;

GetterAbbrevContext.prototype.ID = function() {
    return this.getToken(VenbraceForgivingParser.ID, 0);
};
GetterAbbrevContext.prototype.enterRule = function(listener) {
    if(listener instanceof VenbraceForgivingListener ) {
        listener.enterGetterAbbrev(this);
	}
};

GetterAbbrevContext.prototype.exitRule = function(listener) {
    if(listener instanceof VenbraceForgivingListener ) {
        listener.exitGetterAbbrev(this);
	}
};

GetterAbbrevContext.prototype.accept = function(visitor) {
    if ( visitor instanceof VenbraceForgivingVisitor ) {
        return visitor.visitGetterAbbrev(this);
    } else {
        return visitor.visitChildren(this);
    }
};
...
function GetterVerboseContext(parser, ctx) {
	GetterContext.call(this, parser);
    GetterContext.prototype.copyFrom.call(this, ctx);
    return this;
}

GetterVerboseContext.prototype = Object.create(GetterContext.prototype);
GetterVerboseContext.prototype.constructor = GetterVerboseContext;

VenbraceForgivingParser.GetterVerboseContext = GetterVerboseContext;

GetterVerboseContext.prototype.GET = function() {
    return this.getToken(VenbraceForgivingParser.GET, 0);
};

GetterVerboseContext.prototype.ID = function() {
    return this.getToken(VenbraceForgivingParser.ID, 0);
};

GetterVerboseContext.prototype.GLOBAL = function() {
    return this.getToken(VenbraceForgivingParser.GLOBAL, 0);
};
GetterVerboseContext.prototype.enterRule = function(listener) {
    if(listener instanceof VenbraceForgivingListener ) {
        listener.enterGetterVerbose(this);
	}
};

GetterVerboseContext.prototype.exitRule = function(listener) {
    if(listener instanceof VenbraceForgivingListener ) {
        listener.exitGetterVerbose(this);
	}
};

GetterVerboseContext.prototype.accept = function(visitor) {
    if ( visitor instanceof VenbraceForgivingVisitor ) {
        return visitor.visitGetterVerbose(this);
    } else {
        return visitor.visitChildren(this);
    }
};
...
VenbraceForgivingParser.prototype.getter = function() {
    ...
    try {
        ...
        case VenbraceForgivingParser.ID:
            localctx = new GetterAbbrevContext(this, localctx);
            this.enterOuterAlt(localctx, 1);
            this.state = 567;
            this.match(VenbraceForgivingParser.ID);
            break;
        case VenbraceForgivingParser.GET:
            localctx = new GetterVerboseContext(this, localctx);
            this.enterOuterAlt(localctx, 2);
            this.state = 568;
