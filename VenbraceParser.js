...
var symbolicNames = [ null, "WS", "LCURLY", "RCURLY", "LPAREN", "RPAREN", 
                      ...
                      "NEG_NUM", "ID", "COMPONENT_PROPERTY", "STRING" ];
...
VenbraceParser.RANDOM_INTEGER = 65;
VenbraceParser.RANDOM_FRACTION = 66;
VenbraceParser.MIN = 67;
VenbraceParser.MAX = 68;
VenbraceParser.MOD_OF = 69;
VenbraceParser.REMAINDER_OF = 70;
VenbraceParser.QUOTIENT_OF = 71;
VenbraceParser.RAD_TO_DEG = 72;
VenbraceParser.DEG_TO_RAD = 73;
VenbraceParser.FORMAT_AS_DEC = 74;
VenbraceParser.IS_NUM = 75;
VenbraceParser.SIN = 76;
VenbraceParser.COS = 77;
VenbraceParser.TAN = 78;
VenbraceParser.ASIN = 79;
VenbraceParser.ACOS = 80;
VenbraceParser.ATAN = 81;
VenbraceParser.COLOR = 82;
VenbraceParser.MAKE_COLOR = 83;
VenbraceParser.BLACK = 84;
VenbraceParser.BLUE = 85;
VenbraceParser.WHITE = 86;
VenbraceParser.MAGENTA = 87;
VenbraceParser.RED = 88;
VenbraceParser.LIGHT_GRAY = 89;
VenbraceParser.PINK = 90;
VenbraceParser.GRAY = 91;
VenbraceParser.ORANGE = 92;
VenbraceParser.DARK_GRAY = 93;
VenbraceParser.YELLOW = 94;
VenbraceParser.GREEN = 95;
VenbraceParser.CYAN = 96;
VenbraceParser.MAKE_LIST = 97;
VenbraceParser.LIST = 98;
VenbraceParser.NUMBER = 99;
VenbraceParser.NEG_NUM = 100;
...
VenbraceParser.prototype.open_screen = function() {
    ...
    try {
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        if((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << VenbraceParser.LPAREN) | (1 << VenbraceParser.TRUE) | (1 << VenbraceParser.FALSE))) !== 0) || ((((_la - 99)) & ~0x1f) == 0 && ((1 << (_la - 99)) & ((1 << (VenbraceParser.NUMBER - 99)) | (1 << (VenbraceParser.NEG_NUM - 99)) | (1 << (VenbraceParser.ID - 99)) | (1 << (VenbraceParser.COMPONENT_PROPERTY - 99)) | (1 << (VenbraceParser.STRING - 99)))) !== 0)) {
            this.state = 275;
...
VenbraceParser.prototype.min_max = function() {
    ...
    try {
        ...
        do {
            ...
            this._errHandler.sync(this);
            _la = this._input.LA(1);
        } while((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << VenbraceParser.LPAREN) | (1 << VenbraceParser.TRUE) | (1 << VenbraceParser.FALSE))) !== 0) || ((((_la - 99)) & ~0x1f) == 0 && ((1 << (_la - 99)) & ((1 << (VenbraceParser.NUMBER - 99)) | (1 << (VenbraceParser.NEG_NUM - 99)) | (1 << (VenbraceParser.ID - 99)) | (1 << (VenbraceParser.COMPONENT_PROPERTY - 99)) | (1 << (VenbraceParser.STRING - 99)))) !== 0));
